...
| name | Name of the node group | `string` | `n/a` | yes |
| cluster_name | Name of the EKS cluster | `string` | `n/a` | yes |
| tags | Tags to apply | `map(string)` | `{}` | no |
| labels | Labels to apply | `map(string)` | `{}` | no |
| subnet_ids | Subnets for node group | `list(string)` | `n/a` | yes |
| node_role_arn | IAM role ARN for the node group | `string` | `n/a` | yes |
...
| desired_size | Desired number of nodes | `number` | `n/a` | yes |
| min_size | Minimum number of nodes | `number` | `n/a` | yes |
| max_size | Maximum number of nodes | `number` | `n/a` | yes |
